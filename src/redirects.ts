...
export const redirects = [
	...
	{ from: '^/blog/(?!rss\\.xml/?$)(.*)$', to: '/journal/$1', status: 308 },
	...
	{ from: '/software/sketchpad-1.0*', to: '/labs/sketchpad-1.0/', status: 301 },
	{ from: '/software/zen-bg*', to: '/labs/zen-bg/', status: 301 },
	{ from: '/software*', to: '/labs/', status: 301 },
