...
<style>
	...
	.cs__cell { position: relative; aspect-ratio: 1; border: 1px solid color-mix(in srgb, var(--text) 8%, transparent); border-radius: 0.55rem; background: color-mix(in srgb, var(--panel-bg) 75%, transparent); font: inherit; cursor: pointer; padding: 0; transition: all 140ms; }
	...
	.cs__num { position: absolute; top: 0.35rem; right: 0.4rem; font-size: 0.75rem; font-weight: 600; }
	...
	.cs__hint { margin: 0.6rem 0 0; font-size: 0.7rem; color: color-mix(in srgb, var(--text) 42%, transparent); text-align: center; }
</style>
