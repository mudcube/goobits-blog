...
<style>
	...
	.ts__confirm { width: 100%; display: inline-flex; align-items: center; justify-content: center; gap: 0.3rem; padding: 0.7rem 1rem; border: 1px solid color-mix(in srgb, var(--text) 15%, transparent); border-radius: 999px; background: transparent; color: var(--text); font: inherit; font-size: 0.78rem; font-weight: 600; cursor: pointer; transition: all 180ms; }
	.ts__confirm:hover { background: color-mix(in srgb, var(--text) 6%, transparent); border-color: color-mix(in srgb, var(--text) 25%, transparent); }
</style>
