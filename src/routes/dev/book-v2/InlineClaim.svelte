...
<style>
	...
	.ic__date { margin: 0 0 0.15rem; font-size: 0.58rem; font-weight: 600; color: color-mix(in srgb, var(--text) 50%, transparent); }
	.ic__prompt { margin: 0 0 0.5rem; font-family: var(--font-display); font-size: 1.05rem; font-weight: 500; letter-spacing: -0.02em; }
