...
<div class="tr">
	<div class="tr__times">
		<span class="tr__time" contenteditable="true" spellcheck="false" role="textbox" tabindex="0" onfocus={selectAll} onblur={(e) => commitField(e.currentTarget as HTMLElement, 'start')} onkeydown={(e) => onKeydown(e, 'start')}>{ft(start)}</span>
		<span class="tr__line"></span>
		<span class="tr__dur" contenteditable="true" spellcheck="false" role="textbox" tabindex="0" onfocus={selectAll} onblur={(e) => commitField(e.currentTarget as HTMLElement, 'dur')} onkeydown={(e) => onKeydown(e, 'dur')}>{fDur(duration)}</span>
		<span class="tr__line"></span>
		<span class="tr__time tr__time--end" contenteditable="true" spellcheck="false" role="textbox" tabindex="0" onfocus={selectAll} onblur={(e) => commitField(e.currentTarget as HTMLElement, 'end')} onkeydown={(e) => onKeydown(e, 'end')}>{ft(end)}</span>
	</div>
	{#if wxS && wxE}
		<div class="tr__wx">
