...
<style>
	...
	.cc__capacity { margin: 0; padding: 0.35rem 0.65rem; font-size: 0.58rem; font-weight: 600; color: color-mix(in srgb, var(--text) 38%, transparent); text-align: center; border-top: 1px solid color-mix(in srgb, var(--text) 7%, transparent); }
