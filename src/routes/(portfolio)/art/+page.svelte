<script>
	...
	import { artWorks, artWorkTypes } from '@src/domains/art/content'
...
<PageShell className="showcase-page showcase-page--portfolio showcase-page--art">
