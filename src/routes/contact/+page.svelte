<script lang="ts">
  ...
  import { FormField, Hero, PageShell, PillButton } from "@miko/ui";
  ...
  const messagePlaceholder = $derived.by(() => {
    if (contextFrom === "music" && contextTopic)
      return "Tell me what you need and include any links...";
    if (contextFrom === "art")
      return "Tell me about the piece, timeline, and any reference links...";
    if (contextFrom === "about" && contextTopic)
  ...
  <section class="contact-page__layout">
    <div class="contact-page__form-section">
      ...
      >
        ...
        >
          ...
          {#if !submitting}
            <ChevronRight
              class="contact-page__submit-icon"
              size={18}
              strokeWidth={2.4}
              aria-hidden="true"
            />
        ...
        <p class="contact-page__legal-note">
          By sending this form you agree to our <a href="/privacy"
            >Privacy Policy</a
    ...
    <aside class="contact-page__aside">
      <section class="contact-page__aside-section">
        ...
        <p>
          I usually reply within a day or two. A short note about scope and
          timeline helps me get back faster.
        </p>
      </section>
      <section class="contact-page__aside-section">
