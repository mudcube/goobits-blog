...
function genericFailure(): AntiAbuseResult {
	return {
		ok: false,
		reason: 'blocked',
...
function missingTurnstileSecretResult(env: Record<string, string | undefined>): AntiAbuseResult {
...
export async function runContactAntiAbuse(input: ContactAntiAbuseInput): Promise<AntiAbuseResult> {
