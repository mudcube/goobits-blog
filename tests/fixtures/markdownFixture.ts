...
export const markdownFiles: MarkdownImportRecord = {
	...
	'/content/2024/04/nested/index.md': () => Promise.resolve({
		metadata: {
			title: 'Nested Post',
			date: '2024-04-12',
	...
	'/content/2024/05/draft.md': () => Promise.resolve({
		metadata: {
			title: 'Private Draft',
			date: '2024-05-01',
			draft: true,
