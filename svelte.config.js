...
import { remarkTableOfContents } from './packages/blog/src/server/remark-table-of-contents.js'
...
export default {
	kit: {
		...
		alias: {
			...
			'@static': './static',
			'@packages': './packages',
			'@miko/blog': './packages/blog/src',
			'@miko/blog/server': './packages/blog/src/server/index.ts',
