...
/* MOVEMENT */ var aXY = {}, bXY = {}, oXY = {}, cXY = {}, mXY = "", moXY = {}, mcXY = {}, stop = 1;
core = {
    "X": function(o, m, a, x) {
    ...
    "fu": function(o, e1, C, F) {
        if (stop) {
            var oX = abPos($(o)).X, oY = abPos($(o)).Y, r = XY(e1);
            function c(e, m) {
                r = XY(e);
                if (C) r = C.fu(o, m, {
                    "X": r.X - oX,
            ...
            else oX = oX - C.oX - zero($S(o).left);
            if (isNaN(C.oY)) oY = r.Y - oY;
            else oY = oY - C.oY - zero($S(o).top);
            stop = 0;
            oXY = c(e1);
            cXY = f(e1, mXY = "down");
            core.time = getTime();
    ...
    "win_visible": function(o, s) {
        ...
        if ($C("TMM", o)[0]) $C("TMM", o)[0].style.opacity = op;
...
/* JUNK */ function deObject(o) {
    var z = [];
    for(var i in o)if (typeof o[i] == "object") {
        z[i] = [];
        for(var ii in o[i]){
...
function typeOf(v) {
    ...
    if (z === "object") {
        if (v) {
            if (v instanceof Array) z = "array";
        } else z = "null";
    }
    return z;
}

//# sourceMappingURL=index.f6567975.js.map
