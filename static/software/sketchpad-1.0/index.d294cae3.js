/* CROP */ crop = {
    ...
    "core": function(a, b, m, e) {
        if (m != "down" && (!e || mouse.id || mouse.moved == 1 || getTime() - core.time <= 1250)) {
            ...
            if (m == "up") {
                mouse.reset();
                if (mouse.moveCheck(a, b)) crop.reset();
                else {
                    aXY = a;
                    bXY = b;
                    mouse.fu = function() {
    ...
    "constrain": function(a, b) {
        ...
        if (mouse.id == "n-resize" || mouse.id == "s-resize") {
            if (b.X - a.X > 0 && b.Y - a.Y > 0 || b.X - a.X < 0 && b.Y - a.Y < 0) b.X = a.X + (b.Y - a.Y) * n.B;
            else b.X = a.X - (b.Y - a.Y) * n.B;
            if (b.X > canvas.W) {
                b.X = canvas.W / b.X * b.X;
                if (b.Y < a.Y) b.Y = a.Y - (b.X - a.X) * n.A;
                else b.Y = a.Y + (b.X - a.X) * n.A;
            } else if (a.X < 0) {
                a.X = 0;
                if (b.Y > a.Y) b.Y = a.Y + (b.X - a.X) * n.A;
                else b.Y = a.Y - (b.X - a.X) * n.A;
            ...
            if (b.X - a.X > 0 && b.Y - a.Y > 0 || b.X - a.X < 0 && b.Y - a.Y < 0) b.Y = a.Y + (b.X - a.X) * n.A;
            else b.Y = a.Y - (b.X - a.X) * n.A;
            if (b.Y > canvas.H) {
                b.Y = canvas.H / b.Y * b.Y;
                if (b.X < a.X) b.X = a.X - (b.Y - a.Y) * n.B;
                else b.X = a.X + (b.Y - a.Y) * n.B;
            } else if (b.Y < 0) {
                b.Y = 0;
                if (b.X > a.X) b.X = a.X - (b.Y - a.Y) * n.B;
    ...
    "resize": function() {
        co.del("ctx_temp");
        var w = canvas.W, h = canvas.H, o1 = $C("MM", "canvas")[0].style;
        var l = (parseInt(o1.width) - canvas.W) / 2, t = (parseInt(o1.height) - canvas.H) / 2;
        function fu(o) {
            $(o).width = w;
            $(o).height = h;
            $S(o).left = l + "px";
...
//# sourceMappingURL=index.d294cae3.js.map
