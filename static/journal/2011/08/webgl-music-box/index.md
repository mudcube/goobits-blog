...
Here’s the [WebGL Music Box](http://mudcu.be/labs/Music-Box/) that reads a selection of classical music such as Tchaikovsky’s Waltz of the Flowers from the Nutcracker. And then there is the [interactive](http://mudcu.be/labs/Music-Box/#interactive) version that you can control the notes with your mouse.
