...
Head over to the [Google Chrome Webstore](https://chrome.google.com/webstore/detail/knomilfbnhpkmibhmleppnkmcempglag) and pick up the free browser app! Or _access it online_ at [Color Sphere](http://mudcu.be/sphere/). Let me know what you think about the changes! The [old version](http://mudcu.be/software/Color-Sphere-dev/) can still be accessed for IE8 and below.