...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\daltonize on
     Windows, /home/user/dev/daltonize on Linux) in a file named
     mudcube@gmail.com and copy that file to
