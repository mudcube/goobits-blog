<script lang="ts">
	...
	onMount(() => {
		seedAntiAbuseFields('calendar_register_device_id', formData.update)
	})
</script>

<svelte:head>
	<title>Register</title>
	<meta name="description" content="Account registration for calendar features." />
	<meta name="robots" content="noindex, nofollow, noarchive" />
</svelte:head>

<TurnstileScript siteKey={turnstileSiteKey} />

<Hero title="Create account" subtitle="Set up your account and confirm your email to get started." compact={true} />
