...
function ensureUsers() {
	const users = [
		{ id: 9001, email: 'owner@example.com', name: 'Owner' },
...
function seedEvents() {
	...
	const events = [
		{ activity: 'gym', title: 'Leg Day Crew', ...toIsoIn(1, 18, 0, 75), capacity: 6, cost: 0 },
		{ activity: 'adventure', title: 'Forest Ridge Hike', ...toIsoIn(3, 17, 30, 180), capacity: 4, cost: 1500, paymentProvider: 'cashapp', paymentHandle: 'calendar', paymentNote: 'Adventure ride + snacks' },
		{ activity: 'movie-night', title: 'Movie Night', ...toIsoIn(5, 19, 0, 150), capacity: 8, cost: 700, paymentProvider: 'cashapp', paymentHandle: 'calendar', paymentNote: 'Movie snacks' },
		{ activity: 'circus', title: 'Aerial Fundamentals', ...toIsoIn(7, 18, 30, 120), capacity: 5, cost: 0 },
		{ activity: 'adventure', title: 'Coast Sunset Drive', ...toIsoIn(-2, 16, 0, 240), capacity: 4, cost: 1200, paymentProvider: 'cashapp', paymentHandle: 'calendar', paymentNote: 'Gas split', recap: 'Caught the sunset and made dinner after.', image: null },
		{ activity: 'gym', title: 'Mobility + Sauna', ...toIsoIn(-5, 18, 0, 90), capacity: 6, cost: 0, recap: 'Great reset session. Everyone stayed for the cooldown stretch.', image: null }
	]
