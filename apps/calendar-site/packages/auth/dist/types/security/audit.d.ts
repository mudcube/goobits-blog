...
export type AuthAuditEvent = "auth.success" | "auth.failure" | "magic_link.invalid" | "magic_link.expired" | "webauthn.challenge_missing" | "webauthn.challenge_invalid_type" | "webauthn.challenge_expired" | "webauthn.credential_missing" | "webauthn.authentication_failed" | "session.revoked";
