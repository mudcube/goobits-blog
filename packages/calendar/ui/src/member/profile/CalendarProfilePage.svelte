    ...
    <div class="calendar-home__event-card">
      <div class="calendar-home__event-meta calendar-profile__event-meta">
        ...
        <div class="admin-page__fields-grid calendar-profile__fields-grid">
          <div class="admin-page__field">
            <label
              ...
              for="profile-emergency-contact">Emergency contact</label
            >
            <input
          ...
          <div class="admin-page__field">
            <label
              class="admin-page__field-label"
              for="profile-dietary-restrictions">Dietary restrictions</label
            >
            <input
          ...
          <div class="admin-page__field">
            <label class="admin-page__field-label" for="profile-chat-handle"
        ...
        <div class="calendar-profile__actions">
          ...
          {#if status}<span class="calendar-page__status-text--muted"
              >{status}</span
            >{/if}
        </div>
      </div>
