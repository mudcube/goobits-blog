// Admin barrel — admin-specific surfaces only. Shared primitives (EventCard,
// ChevronRowCard) live in `@calendar/ui/shared` and are imported from there
// directly rather than re-exported here, so this barrel stays focused.
