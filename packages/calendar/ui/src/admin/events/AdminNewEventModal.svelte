  ...
  <div class="admin-page__modal-card" style="max-width: 52rem;">
    ...
    {#if dashboard.eventTemplates.length > 0}
      <div class="admin-page__field admin-page__field--email">
        <label class="admin-page__field-label" for="event-template-copy"
          >Copy from</label
        >
        <select
          id="event-template-copy"
          class="ui-form-control ui-form-control--select"
          onchange={(event) => {
            const value = Number(event.currentTarget.value);
            if (Number.isFinite(value) && value > 0)
              dashboard.applyTemplate(value);
          }}
        >
    ...
    <div class="admin-page__fields-grid">
      <div class="admin-page__fields-row admin-page__fields-row--invite">
        <div class="admin-page__field admin-page__field--email">
          <label class="admin-page__field-label" for="event-draft-activity"
            >Program</label
          >
          <select
            ...
            onchange={(event) =>
              (dashboard.eventDraft = {
                ...dashboard.eventDraft,
                activitySlug: event.currentTarget.value,
              })}
          >
        ...
        <div class="admin-page__field admin-page__field--email">
          <label class="admin-page__field-label" for="event-draft-title"
            >Title</label
          >
          <input
      ...
      <div class="admin-page__fields-row admin-page__fields-row--invite">
        <div class="admin-page__field">
          <label class="admin-page__field-label" for="event-draft-starts"
            >Starts</label
          >
          <input
        ...
        <div class="admin-page__field">
          <label class="admin-page__field-label" for="event-draft-ends"
            >Ends</label
          >
          <input
            id="event-draft-ends"
        ...
        <div class="admin-page__field admin-page__field--uses">
          <label class="admin-page__field-label" for="event-draft-capacity"
            >Capacity</label
          >
          <input
            ...
            oninput={(event) =>
              (dashboard.eventDraft = {
                ...dashboard.eventDraft,
                capacity: Number(event.currentTarget.value) || 1,
              })}
          />
        </div>
        <div class="admin-page__field admin-page__field--expires">
          <label class="admin-page__field-label" for="event-draft-repeat"
            >Repeat weeks</label
          >
          <input
            ...
            oninput={(event) =>
              (dashboard.eventDraft = {
                ...dashboard.eventDraft,
                repeatWeeks: Number(event.currentTarget.value) || 0,
              })}
          />
        </div>
      </div>
      ...
      <div class="admin-page__fields-row admin-page__fields-row--invite">
        <div class="admin-page__field admin-page__field--uses">
          <label class="admin-page__field-label" for="event-draft-cost"
            >Cost (cents)</label
          >
          <input
            id="event-draft-cost"
            ...
            oninput={(event) =>
              (dashboard.eventDraft = {
                ...dashboard.eventDraft,
                costCents: Number(event.currentTarget.value) || 0,
              })}
          />
        </div>
        <div class="admin-page__field admin-page__field--expires">
          <label class="admin-page__field-label" for="event-draft-provider"
          ...
          <select
            ...
            onchange={(event) =>
              (dashboard.eventDraft = {
                ...dashboard.eventDraft,
                paymentProvider: event.currentTarget.value,
              })}
          >
        ...
        <div class="admin-page__field admin-page__field--email">
          <label class="admin-page__field-label" for="event-draft-handle"
          ...
          <input
            ...
            oninput={(event) =>
              (dashboard.eventDraft = {
                ...dashboard.eventDraft,
                paymentHandle: event.currentTarget.value,
              })}
          />
        </div>
        <div class="admin-page__field admin-page__field--email">
          <label class="admin-page__field-label" for="event-draft-note-template"
            >Payment note</label
          >
          <input
            ...
            oninput={(event) =>
              (dashboard.eventDraft = {
                ...dashboard.eventDraft,
                paymentNoteTemplate: event.currentTarget.value,
              })}
          />
        </div>
      </div>
    ...
    <div class="admin-page__modal-actions">
      ...
      <PillButton
        ...
        disabled={dashboard.eventsCreating}
      >
