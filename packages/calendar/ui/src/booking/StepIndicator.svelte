...
<style>
	...
	.si__line--done { background: var(--book-accent); }
	...
	.si__step--visited .si__dot { border-color: color-mix(in srgb, var(--book-accent) 40%, transparent); color: color-mix(in srgb, var(--book-accent) 50%, transparent); cursor: pointer; }
	.si__step--visited .si__label { color: color-mix(in srgb, var(--book-accent) 40%, transparent); }
</style>
