(function() {
    ...
    TEST = function() {
        ...
        function objectToStr(object, depth) {
            ...
            for(var key in object)output += indent + valueToStr(key) + ": " + valueToStr(object[key], depth) + ",\n";
        ...
        return function(value, aggregate, MAX) {
            ...
            // recurse
            max = MAX || 2;
            if (typeof value != "string") value = valueToStr(value, depth1);
    ...
    dump = function(object, aggregate, showTypes) {
        ...
        function recurse(o, type) {
            ...
            if (/object|array/.test(type)) for(i in o){
                var t = _dumpType(o[i]);
                if (j < 1) {
                    r += "<table" + _dumpStyles(type, "table") + '><tr><th colspan="2"' + _dumpStyles(type, "th") + ">" + type + "</th></tr>";
                    j++;
                }
                if (typeof o[i] == "object" && o[i] != null) r += "<tr><td" + _dumpStyles(type, "td-key") + ">" + i + (st ? " [" + t + "]" : "") + "</td><td" + _dumpStyles(type, "td-value") + ">" + recurse(o[i], t) + "</td></tr>";
                else if (typeof o[i] == "function") r += "<tr><td" + _dumpStyles(type, "td-key") + ">" + i + (st ? " [" + t + "]" : "") + "</td><td" + _dumpStyles(type, "td-value") + ">" + recurse(o[i], t) + "</td></tr>";
                else r += "<tr><td" + _dumpStyles(type, "td-key") + ">" + i + (st ? " [" + t + "]" : "") + "</td><td" + _dumpStyles(type, "td-value") + ">" + o[i] + "</td></tr>";
            }
    ...
    var _dumpIdentifyBrowser = function() {
        ...
        if (typeof window.opera != "undefined") return "opera";
            ...
            if (navigator.vendor.indexOf("Apple Computer, Inc.") != -1) return "safari";
    ...
    var _dumpType = function(obj) {
        ...
        if (t == "function") {
            ...
            else if (/^\[object.*\]$/i.test(f)) t = "object";
        }
...
//# sourceMappingURL=index.c4e4dc7c.js.map
