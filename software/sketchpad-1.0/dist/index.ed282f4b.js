const init = {
    ...
    "events": function() {
        ...
        o.onmousedown = function(e) {
            if (vars.type === "crop") co.core(e, crop.core);
            else if (vars.type === "fill") co.core(e, draw.fill);
            else if (vars.type === "marquee") co.core(e, marquee.core);
            ...
            } else if (vars.type === "shape") co.core(e, draw.shape);
            else if (vars.type === "text") co.core(e, draw.text);
            else if (({
                "calligraphy": 1,
                "stamp": 1
            })[vars.type]) {
                if (stamp.loaded) co.core(e, draw[vars.type]);
                else noMove();
            } else if (vars.type === "spirograph") co.core(e, draw.spirograph);
            else if (({
                "brush": 1,
                "pencil": 1,
                "eraser": 1
            })[vars.type]) co.core(e, draw[vars.type]);
            else return noMove();
            return false;
        };
...
//# sourceMappingURL=index.ed282f4b.js.map
