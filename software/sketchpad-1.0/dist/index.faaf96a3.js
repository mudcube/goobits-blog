canvas = {
    ...
    "history_mk": function() {
        ...
        for(var i = 0; i <= canvas.history_n; i++)z += '<canvas id="history_' + i + '" width="' + canvas.W + '" height="' + canvas.H + '">' + "</canvas>";
    ...
    "history_set": function(v, s) {
        if ($("history_0")) {
            ...
            if (isNaN(v)) {
                ...
                if (r.r[r.n + 1]) for(var i = r.n + 1; i <= z; i++)r.data[i] = [];
            ...
            if (b == "ctx_box") c.drawImage($("ctx_temp"), 0, 0, canvas.W, canvas.H);
            if (!s) o.cur[o.id] = r.z - 5;
            o.hi(1);
    ...
    "load": function(u, w, h) {
        ...
        if (u) {
            ...
            c1.rect(a.X, a.Y, b.X, b.Y);
            co.style[vars[vars.id]](a, b, c1, "fill", 1);
        }
    },
    "resize": function(w, h) {
...
//# sourceMappingURL=index.faaf96a3.js.map
