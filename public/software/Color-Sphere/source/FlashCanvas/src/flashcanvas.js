...
function onDomContentLoaded() {
	Event.remove(document, DOM_CONTENT_LOADED, onDomContentLoaded, false);
...
function onUnload() {
	Event.remove(window, UNLOAD, onUnload, false);
    ...
    for (var canvasId in canvases) {
		...
		Event.remove(swf, FOCUS, onFocus, false);
		Event.remove(canvas, PROPERTY_CHANGE, onPropertyChange, false);
    }
...
//      }
        ...
        // add event listener
		Event.add(swf, FOCUS, onFocus, false);
    ...
    unlock: function(canvasId, url, error) {
        ...
        if (url === undefined) {
            ...
            // Add event listener
			Event.add(canvas, PROPERTY_CHANGE, onPropertyChange, false);
...
if (document.readyState === "complete") {
	...
	Event.add(document, DOM_CONTENT_LOADED, onDomContentLoaded, false);
}

// prevent IE6 memory leaks
Event.add(window, UNLOAD, onUnload, false);
