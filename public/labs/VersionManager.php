<?php
/*
	VersionManager : 0.11 : 11.11.2010
	----------------------------------
	...
	$language = $manager->getIP(); // get preferred language
...
class VersionManager {
	public function __construct($features) {
		try { // requires browscap ini directive
			$this->agent = get_browser($_SERVER['HTTP_USER_AGENT'], true);
		} catch (Exception $e) {
			return;
		}	   	
	   	$agent = $this->agent["browser"];
	   	$ver = $this->agent["version"] ? $this->agent["version"] : 0;
...
EOF;
		...
		$this->fix = $FIX ? "<!-- VersionManager: {$agent} {$ver} -->\n{$FIX}" : "";
		$json = '{"IE":{"wikipedia":"Internet_Explorer","stable":{"ver":"8.0","url":"http:\/\/www.microsoft.com\/windows\/internet-explorer\/default.aspx"},"preview":{"ver":"9.0 beta","url":"http:\/\/www.microsoft.com\/windows\/internet-explorer\/default.aspx"}},"Chrome":{"wikipedia":"Google_Chrome","stable":{"ver":"7.0.517.44","url":"http:\/\/www.google.com\/landing\/chrome\/beta\/"},"preview":{"ver":"8.0.552.28 beta","url":"http:\/\/www.google.com\/landing\/chrome\/beta\/"}},"Chromium":{"wikipedia":"Chromium_(web_browser)","stable":null,"preview":{"ver":"9.0.580.0","url":"http:\/\/code.google.com\/chromium\/"}},"Firefox":{"wikipedia":"Mozilla_Firefox","stable":{"ver":"3.6.12","url":"http:\/\/www.mozilla.com\/en-US\/firefox\/all-beta.html"},"preview":null},"Safari":{"wikipedia":"Safari_(web_browser)","stable":{"ver":"5.0.2","url":"http:\/\/www.apple.com\/safari\/download\/"},"preview":null},"Opera":{"wikipedia":"Opera_(web_browser)","stable":{"ver":"10.63 (Build 3516)","url":"http:\/\/www.opera.com\/browser\/next\/"},"preview":{"ver":"11.00 Alpha (Build 1060)","url":"http:\/\/www.opera.com\/browser\/next\/"}},"Camino":{"wikipedia":"Camino","stable":{"ver":"2.0.5","url":"http:\/\/preview.caminobrowser.org\/"},"preview":null},"Konqueror":{"wikipedia":"KDE_Software_Compilation_4","stable":{"ver":"4.5.3","url":"http:\/\/www.kde.org\/download\/"},"preview":{"ver":"4.5 RC3","url":"http:\/\/www.kde.org\/download\/"}},"Flock":{"wikipedia":"Flock_(web_browser)","stable":{"ver":"2.6.1","url":"http:\/\/www.flock.com\/beta\/download"},"preview":{"ver":"3.0 beta","url":"http:\/\/www.flock.com\/beta\/download"}},"SeaMonkey":{"wikipedia":"SeaMonkey","stable":{"ver":"2.0.10","url":"http:\/\/www.seamonkey-project.org\/"},"preview":null},"Songbird":{"wikipedia":"Songbird_(software)","stable":{"ver":"1.8.0","url":"http:\/\/getsongbird.com\/download\/"},"preview":{"ver":"1.8.0","url":"http:\/\/getsongbird.com\/download\/"}}}';
