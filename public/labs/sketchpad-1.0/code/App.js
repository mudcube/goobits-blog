...
window.onload = function () {
	if (document.location.hash == '#snapshot') {
		...
		window.onmessage = function (event) {
			if (event.origin.indexOf('chrome-extension:') == -1) if (event.origin != 'http://mugtug.com') if (event.origin != 'https://mugtugdarkroom.appspot.com') if (event.origin != 'https://mugtugsketchpad.appspot.com') return;
